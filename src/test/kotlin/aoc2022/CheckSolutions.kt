...
class CheckSolutions {
    ...
    fun testDay08() {
        val day08 = day08()
        assertEquals(1672, day08.first)
        assertEquals(327180, day08.second)
    }
    ...
    fun testDay13() {
        val day13 = day13()
        assertEquals(6420, day13.first)
        assertEquals(22000, day13.second)
    }

    @Test
    fun testDay14() {
        val day14 = day14()
        assertEquals(737, day14.first)
        assertEquals(28145, day14.second)
    }
}
